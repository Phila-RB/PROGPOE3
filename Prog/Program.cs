    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Dictionary<string,List<string>> dictionary = new Dictionary<string, List<string>>()
            {
                ...
                { "how are you", new List<string>(){ "Im good thanks! how can i help you today","Im great thanks and yourself?", "Im awesome yo, how can i be of service" } },
                { 
                ...
                } },
                {
                  ...
                  "Safe Browsing is a security service made by google that protects user devices by warning them before they visit dangerous websites, download malicious software, or fall victim to phishing attacks. It scans the web to identify, warn, and protect users in real-time across Chrome, Android, and Gmail.",
        ...
        public static void Ask(string question, Dictionary<string, List<string>> list){
            ...
            if (list.ContainsKey(question))
            {
                ...
                Console.WriteLine("contained key" + question + list.ContainsKey(question));
                  Ask(newQ, list);
            ...
            if (!list.ContainsKey(question))
            {
                ...
                if (question == "")
                {
                    Console.WriteLine("You just entered nothing, please ask an actaull question or ask: what can i ask about?");
